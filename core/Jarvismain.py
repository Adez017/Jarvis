...
from Jarvis.Features.communication.Whatsapp import sendMessage
from Jarvis.Features.System.battery import check_battery
import pygame
...
#! For Executing all tasks.
    while True:
        ...
        if "wake up" in query or "start" in query or "makeup" in query or "breakup"in query:
            from Jarvis.core.GreetMe import greetMe
            greetMe()
            ...
            while True:
                ...
                if "go to sleep" in query:
                    ...
                    from Jarvis.Features.utilities.Translator import translategl
                    query = query.replace("jarvis translate","")
                    query = query.replace("translate","")
                    translategl(query)

                elif "joke" in query:
                    from Jarvis.Features.entertainment.joke import jokes
                    jokes()
                ...
                #! By this Function be can know our battery percentage.
                    ...
                    from Jarvis.Features.System.battery import battery
                    battery()
                ...
                #*Focus Mode Function.
                    ...
                    from Jarvis.Features.utilities.FocusGraph import focus_graph
                    focus_graph()

                elif "open game" in query:
                    from Jarvis.Features.entertainment.game import game_play
                    game_play()                
                ...
                #& Finding you current location.
                    ...
                    from Jarvis.Features.utilities.Location import My_Location
                    My_Location()
                ...
                #^ To reaching any website or page.
                    ...
                    from Jarvis.Features.search.SearchNow import searchGoogle
                    searchGoogle(query)

                elif "youtube" in query:
                    from Jarvis.Features.search.SearchNow import searchyoutube
                    searchyoutube(query)
                
                elif "wikipedia" in query:
                    from Jarvis.Features.search.SearchNow import searchwikipedia
                ...
                #& Youtube Running Shortcuts.
                    ...
                    from Jarvis.Features.System.keyboard import volumeup
                    Speak("Turning volume up,sir")
                    volumeup()
                elif "volume down" in query:
                    from Jarvis.Features.System.keyboard import volumedown
                ...
                #& To listen newses.
                    ...
                    from Jarvis.Features.entertainment.NewsRead import latestnews
                    latestnews()

                #^ Send whatsapp message by pyautogui
                elif "whatsapp message" in query:
                    from Jarvis.Features.communication.Whatsappmessage import sendwhatsapp
                    sendwhatsapp()
                ...
                #! Send Call by Twilio.
                    ...
                    from Jarvis.Features.utilities.sendcall import send_call
                    send_call()
                ...
                #*Reminder set.
                    ...
                    from Jarvis.Features.utilities.reminder import remindme
                    remindme()
                ...
                #* To Calculate any digit.
                    ...
                    from Jarvis.Features.utilities.Calculatenumbers import WolfRamAlpha
                    from Jarvis.Features.utilities.Calculatenumbers import Calc
                ...
                if "write an email" in query:
                    ...
                    from Jarvis.Features.communication.sendemail import recipient_mapping
                    ...
                    if recipient_email:
                        ...
                        from Jarvis.Features.communication.sendemail import send_email
                        from Jarvis.Features.communication.sendemail import sender_email
                        from Jarvis.Features.communication.sendemail import sender_password
